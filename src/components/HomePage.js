...
function HomePage() {
    return (
        ...
        <div id="hero">
            <header>
                <div id="nav">
                    <a href="index.html">Submit a Business</a>
                </div>
            </header>
        ...
        {/* <div id="local">
            ...
            <p>Purchase at locally owned businesses allow more money to be kept in the community because locally-owned
                businesses often purchase from other local businesses, service providers and farms.</p>
        ...
        {/* <div id="spotlight">
            ...
            <p>Seattle,WA</p>
            <p>“We opened our doors in the city of Seattle in February of 2008. We use all natural ingredients in our
                food and make our own secret recipe hot sauces for your dinning delight. Enjoy our complete Breakfast,
                Lunch, and Dinner Menus 24 hours a day. Don’t Forget to ask about our complete kid’s menu. Come down
                anytime to enjoy the best of the Northwest’s Authentic Mexican cuisine at Memo’s Mexican Food
                Restaurant.”</p>
            <p>-Memo Murillo</p>
            <p>Minority-Owner</p>
